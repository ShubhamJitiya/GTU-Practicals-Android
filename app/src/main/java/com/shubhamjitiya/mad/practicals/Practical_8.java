...
import com.shubhamjitiya.mad.adapter.CourseRVAdapter;
import com.shubhamjitiya.mad.adapter.StudentDetailsAdapter;
import com.shubhamjitiya.mad.data.CourseModal;
import com.shubhamjitiya.mad.data.StudentsData;
import com.shubhamjitiya.mad.view_model.ViewModal;
...
public class Practical_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView coursesRV = (RecyclerView) findViewById(R.id.idRVCourses);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Practical_8.this, NewCourseActivity.class);
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                Toast.makeText(Practical_8.this, "Course deleted", Toast.LENGTH_SHORT).show();
            }
        }).
